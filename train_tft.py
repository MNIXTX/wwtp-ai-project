...
from tft_pure_pytorch import TFTEngine, TrainConfig
from utils.tft_dataset import TFTDataset
...
def train_tft():
    ...
    if y_train_np.ndim == 3:
        y_train_np = y_train_np[:, -1, :]   # (N, horizon, 1) -> (N, 1)
    elif y_train_np.ndim == 2 and y_train_np.shape[1] > 1:
        y_train_np = y_train_np[:, -1:]     # (N, horizon) -> (N, 1)
